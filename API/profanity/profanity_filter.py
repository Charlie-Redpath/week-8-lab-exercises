...
class ProfanityFilter:
    def __init__(self):
        ...
        self.default_wordlist_filename = get_complete_path('API/profanity/data/profanity_wordlist.txt')
        self.default_urls_filename = get_complete_path('API/profanity/data/profane_sites.txt')
